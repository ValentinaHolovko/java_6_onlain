...
public class Main {
    public static void main(String[] args) {
        ...
        students[1] = new Aspirant("Emily", "Smith", "A123", 4.0, "Research on AI");
        students[2] = new Student("Michael", "Johnson", "A123", 4.8);
        students[3] = new Aspirant("Jessica", "Williams", "A123", 4.2, "Research on AI");
        students[4] = new Student("David", "Brown", "A123", 5.0);
        students[5] = new Aspirant("Sarah", "Garcia", "A123", 4.9, "Research on AI");
